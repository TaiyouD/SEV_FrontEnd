          ...
          <v-col cols="5">
            <v-card>
              <v-img
                ...
                cover
              >
              <v-card-title class="white--text">How to Sign-Up for Events</v-card-title>
              </v-img>
              ...
              <v-card-text>
                ...
                >
                  ...
                  <v-carousel-item>
                    <h3>
                      Sign-Up for Scholarship Opportunities
                    </h3>
                    <p>
                      An OC student you should follow this proccess to sign-up for a Senior or Junior Capstone Recitial:
                      <br>
